...
const clevelandPlotmargin = { top: 10, right: 80, bottom: 50, left: 80 },
  clevelandPlotwidth =
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Promise.all([
    ...
    d3.csv("merged_data/BubbleGraphAlgoData.csv"),
...
function drawSGraph(country, survival) {
  ...
  function mousemove(d, i) {
    ...
    // mousex = mousex[0];
    // mousex = xScale.invert(mousex);
    // var z = new Date(mousex);
    // z = z.getMonth() + z.getDate();
  ...
  streamGraphSvg
    ...
    .on("mouseover", function (d, i) {
      ...
      // var t = d3.pointer(this);

      // // var c = t.find(function (s) {
      // //   if (s.data["Aleppo_Hosp"] == 24842)
      // //     return s.data[country + "_" + survival];
      // // });
      // Tooltip.html("hosp:" + "" + "  ")
